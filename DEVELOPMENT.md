...
```bash
git remote add encore encore://sacred-shifter-app-twm2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/sacred-shifter-app-twm2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/sacred-shifter-app-twm2/settings/integrations/github)
